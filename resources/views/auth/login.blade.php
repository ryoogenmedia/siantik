<x-layouts.auth title="Login">
    <form class="mt-32" action="https://themesflat.co/html/grocery/grocery/index.html">
        <fieldset>
            <label>Email</label>
                ...
                <div class="show-pass">
                    <span class="icon-view">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
                            <path
                                d="M0.833496 10.0007C0.833496 10.0007 4.16683 3.33398 10.0002 3.33398C15.8335 3.33398 19.1668 10.0007 19.1668 10.0007C19.1668 10.0007 15.8335 16.6673 10.0002 16.6673C4.16683 16.6673 0.833496 10.0007 0.833496 10.0007Z"
                    ...
                    <span class="icon-hide">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                            ...
                            <g clip-path="url(#clip0_1_4474)">
                                <path
                                    d="M0.833496 10.0007C0.833496 10.0007 4.16683 3.33398 10.0002 3.33398C15.8335 3.33398 19.1668 10.0007 19.1668 10.0007C19.1668 10.0007 15.8335 16.6673 10.0002 16.6673C4.16683 16.6673 0.833496 10.0007 0.833496 10.0007Z"
                                    stroke="#787982" stroke-width="1.5" stroke-linecap="round"
        ...
        <button class="mt-32 tf-btn primary">Login</button>
    </form>
</x-layouts.auth>
